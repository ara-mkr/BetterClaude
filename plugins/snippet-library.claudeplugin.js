...
module.exports = {
  ...
  onLoad(api) {
    ...
    api.injectCSS(`
      ...
      .bc-sl-form-save { background: #8b5cf6; color: #fff; }
  ...
  insertSnippet(text) {
    const composer = this.api.query('[data-testid="composer"] textarea, form textarea, textarea');
    if (!composer) {
    ...
    nativeSetter.call(composer, (composer.value ? composer.value + "\n" : "") + text);
