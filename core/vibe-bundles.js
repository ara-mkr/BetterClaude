...
async function applyBundle(bundle, { setSetting, applyBundlePreview } = {}) {
  if (!bundle || !setSetting) return;
  if (applyBundlePreview) applyBundlePreview(bundle);
  await setSetting("appearance.activeTheme", bundle.themeId);
